...
export function Prompt(props: PromptProps) {
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      {
        title: "Mở trình soạn thảo (editor)",
        category: "Session",
        name: "prompt.editor",
        slashName: "editor",
        run: async () => {
      ...
      {
        title: "Chuyển không gian làm việc (warp)",
        desc: "Thay đổi workspace cho phiên làm việc",
        name: "workspace.set",
        category: "Session",
      ...
      {
        title: "Di chuyển phiên làm việc (move)",
        desc: "Chuyển phiên làm việc sang thư mục dự án khác",
        name: "session.move",
        category: "Session",
        slashName: "move",
        run: () => {
  ...
  const placeholderText = createMemo(() => {
    ...
    return `Ask KhoaAI... "${list()[store.placeholder % list().length]}"`
  })
